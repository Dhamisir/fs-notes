...
export const module1Sections = [
  ...
  },
  {
    ...
    emoji: "📗",
    subtitle:
      "Core interview patterns: pointers, windows, hashing, and prefix sums.",
    topics: [
      {
        slug: "two-pointer-basics",
        topic: "Two Pointer Basics",
        concepts: "Left/right pointer",
        problems: "Reverse string, palindrome",
        goal: "Reduce nested loops",
      },
      {
        slug: "two-pointer-advanced",
        topic: "Two Pointer Advanced",
        concepts: "Pointer optimization",
        problems: "Remove duplicates, container water",
        goal: "Pattern mastery",
      },
      {
        slug: "sliding-window-intro",
        topic: "Sliding Window Intro",
        concepts: "Fixed-size window",
        problems: "Max sum subarray K",
        goal: "Window concept",
      },
      {
        slug: "sliding-window-advanced",
        topic: "Sliding Window Advanced",
        concepts: "Variable window",
      ...
      },
      {
        ...
        problems: "Majority element, Two Sum",
        goal: "Hashing intuition",
      },
      {
        slug: "prefix-sum",
        topic: "Prefix Sum",
        concepts: "Running cumulative sum",
        problems: "Subarray sum",
        goal: "Range optimization",
      },
      {
        slug: "revision-contest",
        topic: "Revision + Contest",
        concepts: "Mixed questions",
        problems: "Weekly practice set",
        goal: "Pattern reinforcement",
      },
    ],
  },
];
